package com.i0dev.ancientruins.util;
...
public class ItemBuilder extends ItemStack {
    ...
    public ItemBuilder addPDCValue(String key, String value) {
        ...
        pdc.set(new NamespacedKey(AncientRuinsPlugin.get(), key), PersistentDataType.STRING, value);
        setItemMeta(im);
        return this;
    }
    ...
    public static String getPDCValue(ItemStack item, String key) {
        ...
        return pdc.get(new NamespacedKey(AncientRuinsPlugin.get(), key), PersistentDataType.STRING);
    }
