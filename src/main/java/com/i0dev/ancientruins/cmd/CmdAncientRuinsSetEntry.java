...
public class CmdAncientRuinsSetEntry extends AncientRuinsCommand {

    public CmdAncientRuinsSetEntry() {
    ...
    public void perform() {
        ...
        MConf.get().setEntryPortal(new Cuboid(selection.getMinimumPoint(), selection.getMaximumPoint(), Bukkit.getWorld(selection.getWorld().getName())));
        MConf.get().changed();
        msg("&aSet entrypoint");
    }
